...
net = cv2.dnn.readNetFromCaffe("data/MobileNet/mobilenet.caffemodel", "data/MobileNet/mobilenet_deploy.prototxt", "data/MobileNet/synset.txt")
#2 зчитуємо список назв в класі

classes = []
with open("data/MobileNet/synset.txt") as f:
    for line in f:
        line = line.strip()
        if not line:
            continue
...
image = cv2.imread("data/MobileNet/img.png")
...
#6 знаходимо індекс класу з найбільшою іймовірністю
